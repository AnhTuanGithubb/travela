...
<main class="main">
        ...
        {{-- <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/01.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Flight Grid</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="index-2.html">Home</a></li>
                    <li class="active">Flight Grid</li>
                </ul>
            </div>
        </div> --}}
        <!-- breadcrumb end -->
        ...
        <!-- flight booking -->
        <div class="flight-booking flight-grid pt-80 pb-120">
            <div class="container">
                <div class="row">
                    <!-- booking sidebar -->
                        ...
                        <div class="col-md-12">
                            <div class="booking-sort">
                                ...
                                <div class="booking-sort-list-grid">
                                    <a class="booking-sort-grid active" href="flight-grid.html"><i
                                            class="far fa-grid-2"></i></a>
                                    <a class="booking-sort-list" href="flight-list.html"><i
