            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                ...
                <div class="card booking-summary border-0 h-100 shadow-sm">
                    ...
                    <div
                        ...
                        <span
                            class="badge {{ $booking->bookingStatus == 'Pending' ? 'bg-warning text-dark' : 'bg-success' }}">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between p-3">
                        ...
                        <div>
                            <dl class="row small mb-2">
                                ...
                                {{-- Giá người lớn --}}
                                <dt class="col-5"><i class="fas fa-user text-success me-2"></i> Giá người lớn:</dt>
                                ...
                                <dt class="col-5"><i class="fas fa-child text-success me-2"></i> Giá trẻ em:</dt>
                                <dd class="col-7 text-end fw-bold mb-1">
                                    {{ number_format($booking->priceChild ?? 0) }} VNĐ</dd>

                                {{-- Ngày đặt --}}
                                <dt class="col-5"><i class="far fa-calendar-alt text-secondary me-2"></i> Ngày đặt:</dt>
                                <dd class="col-7 text-end mb-1">
                                    {{ \Carbon\Carbon::parse($booking->bookingDate)->format('d/m/Y') }}
                                </dd>

                                {{-- Trạng thái --}}
                                <dt class="col-5"><i class="fas fa-signal text-warning me-2"></i> Trạng thái:</dt>
                                <dd class="col-7 text-end mb-1">
                                    <span
                                        class="badge {{ $booking->bookingStatus == 'Pending' ? 'bg-warning text-dark' : 'bg-success' }}">
                                        {{ $booking->bookingStatus }}
                                ...
                                {{-- Đánh giá --}}
                                <dt class="col-5"><i class="fas fa-star text-warning me-2"></i> Đánh giá:</dt>
                                ...
                                <dd class="col-7 text-end fw-bold text-danger">{{ number_format($booking->totalPrice ?? 0) }} VNĐ</dd>
